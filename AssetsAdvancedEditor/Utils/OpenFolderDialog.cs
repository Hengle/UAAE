...
namespace AssetsAdvancedEditor.Utils
{
    ...
    public sealed class OpenFolderDialog
    {
        ...
        /// <summary>
        ///  Runs a common folder dialog box.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///  Runs a common folder dialog box, parented to the given IWin32Window.
        /// </summary>
        /// <returns><see cref="DialogResult.OK"/> if the user clicks OK in the dialog box; otherwise, <see cref="DialogResult.Cancel"/></returns>
        ...
        public DialogResult ShowVistaDialog(IWin32Window owner)
        {
            ...
            if (InitialFolder != null)
            {
                ...
                if (NativeMethods.SHCreateItemFromParsingName(InitialFolder, IntPtr.Zero, ref riid,
                    out var directoryShellItem) == NativeMethods.S_OK) frm.SetFolder(directoryShellItem);
            }

            if (DefaultFolder != null)
            {
                var riid = new Guid("43826D1E-E718-42EE-BC55-A1E261C37BFE"); //IShellItem
                if (NativeMethods.SHCreateItemFromParsingName(DefaultFolder, IntPtr.Zero, ref riid,
                    out var directoryShellItem) == NativeMethods.S_OK) frm.SetDefaultFolder(directoryShellItem);
            }
    ...
    internal static class NativeMethods
    {
        ...
        internal static extern int SHCreateItemFromParsingName([MarshalAs(UnmanagedType.LPWStr)] string pszPath,
            IntPtr pbc, ref Guid riid, [MarshalAs(UnmanagedType.Interface)] out IShellItem ppv);
        ...
        internal interface IFileDialog
        {
            ...
            [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
            uint SetFileTypes([In] uint cFileTypes, [In] [MarshalAs(UnmanagedType.LPArray)]
                IntPtr rgFilterSpec);
        ...
        {
            [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
            uint BindToHandler([In] IntPtr pbc, [In] ref Guid rbhid, [In] ref Guid riid,
